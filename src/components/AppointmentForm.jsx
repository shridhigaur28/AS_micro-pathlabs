        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          <div className="p-8 md:p-12">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="mb-8">
                <label className="block text-sm font-medium text-gray-700 mb-4 text-center md:text-left">
                ...
                {bookingTypeError && (
                  <p className="mt-2 text-sm text-red-600">Please select booking type</p>
                )}
              </div>
                    ...
                    <label className="flex items-center">
                      <input
                        ...
                        {...register('collectionType', {
                          required: 'Please select a collection type',
                        })}
