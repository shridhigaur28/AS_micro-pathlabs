...
export default function Footer() {
  return (
    <footer className="bg-[#2d2d4a] text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#hero" className="text-white hover:text-[#2d9e8f] transition-colors">Home</a></li>
              <li><a href="#packages" className="text-white hover:text-[#2d9e8f] transition-colors">Packages</a></li>
              <li><a href="#tests" className="text-white hover:text-[#2d9e8f] transition-colors">Tests</a></li>
              <li><a href="#about" className="text-white hover:text-[#2d9e8f] transition-colors">About</a></li>
              <li><a href="#contact" className="text-white hover:text-[#2d9e8f] transition-colors">Contact</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+919910908530" className="hover:text-white transition-colors">+91 99109 08530</a>
              </li>
              <li className="flex items-center">
                <MessageCircle className="w-5 h-5 mr-3 text-[#25d366] flex-shrink-0" />
                <a href="https://wa.me/919910908530" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+91 99109 08530 (WhatsApp No.)</a>
              </li>
